...
class FileHandler():
    def __init__(self) -> None:
        ...
        self.specs_files = [f for f in self.__get_files_in_spec_folder(self.specs) if self.__get_extension(f) == 'csv']
        self.data_files = [f for f in self.__get_files_in_spec_folder(self.data) if self.__get_extension(f) == 'txt']
    
    @staticmethod
    def __get_files_in_spec_folder(path: str) -> list:
